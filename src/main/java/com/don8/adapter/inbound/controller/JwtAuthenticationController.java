...
import com.don8.core.model.response.GenericResponse;
import com.don8.core.port.inbound.IUserService;
import com.don8.core.port.inbound.IEmailVerification;
...
public class JwtAuthenticationController {
    ...
    public ResponseEntity<?> getTokenDetails( HttpServletRequest request){
        return ResponseEntity.ok(tokenUtil.getUserFromToken(request));
    }
